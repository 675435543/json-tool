...
const posts = [
  ...
  { slug: '10-common-json-errors', title: '10 Common JSON Errors and How to Fix Them — Developer Guide', excerpt: 'Learn the 10 most common JSON errors: trailing commas, single quotes, unquoted keys, missing brackets, comments, Python-style booleans, and more. Practical fixes for each.', date: '2026-07-20' },
  { slug: 'json-formatter-guide', title: 'JSON Formatter Online — Make Your JSON Clean, Readable & Debuggable', excerpt: 'Free online JSON formatter & beautifier with built-in validation. 100% client-side — your data stays private. Common use cases for developers and data analysts.', date: '2026-07-20' },
